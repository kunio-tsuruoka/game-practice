...
drawShapes() {
 ...
 // Draw full circle below the rectangle
    ...
    ctx.fillStyle = '#FFDEAD';
    ctx.beginPath();
    ctx.arc(rectX + rectWidth / 2, rectY + rectHeight + circleRadius, circleRadius, 0, 2 * Math.PI, false);
   

    // Draw circles at the rectangle's ends
    // Left circle
    ctx.beginPath();
    ctx.arc(rectX, rectY + 20 + rectHeight / 2, circleRadius, 0, 2 * Math.PI, false);
    ctx.fill();
      ctx.stroke();

    // Right circle
    ctx.beginPath();
    ctx.arc(rectX + rectWidth, rectY + 20 + rectHeight / 2, circleRadius, 0, 2 * Math.PI, false);
    ctx.fill();
      ctx.stroke();
},
    jump() {
